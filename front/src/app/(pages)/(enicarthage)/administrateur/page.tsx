    ...
    <div className="h-full flex-center flex-col bg-gradient-to-br from-[#1A233B] to-[#0f172a] relative overflow-hidden">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-md leading-relaxed">
          Vous êtes connecté au panneau de contrôle{" "}
          <span className="font-semibold text-purple-300">ENICarthage</span>
        </p>
        ...
        <div className="flex space-x-4 mt-8">
          {[0, 1, 2].map((i) => (
            <motion.div
              ...
              className="w-3 h-3 rounded-full bg-gradient-to-r from-purple-400 to-blue-300 shadow-blue-glow"
            />
          ))}
        </div>
      </motion.div>
      ...
      >
        <p className="text-sm text-gray-400/80">
          Plateforme de gestion ENICarthage - {new Date().getFullYear()}
        </p>
        <div className="mt-1 h-px w-24 mx-auto bg-gradient-to-r from-transparent via-purple-400 to-transparent" />
      </motion.div>
    </div>
  );
}