            ...
            <tr key={student.id} className="border-b border-gray-300">
              ...
              <td className="p-2 border border-gray-300">
                <select
                  ...
                  className={`p-1 rounded ${student.hasSentence ? "text-green-600" : "text-red-600"}`}
                >
                  <option value="yes" className="text-green-600">Oui</option>
                  <option value="no" className="text-red-600">Non</option>
                </select>
              </td>
              <td className="p-2 border border-gray-300">{student.sentenceLanguage || "N/A"}</td>
              <td className="p-2 border border-gray-300">{student.profs.join(", ")}</td>
            </tr>
          ))}
        </tbody>
      </table>
